...
5. At the ABSOLUTE END of your response, you MUST always suggest exactly 3 short, highly relevant follow-up questions that the user can ask next to explore this data deeper. Format these questions at the very end of your response using the special block tag [SUGGESTED_QUESTIONS] on a new line like this:
